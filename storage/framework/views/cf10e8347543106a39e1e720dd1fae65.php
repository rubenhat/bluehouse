    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white shadow-md fixed h-full">
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href=<?php echo e(route('admin.laporan-transaksi')); ?> class="flex items-center p-3 rounded-lg hover:bg-gray-100">
...
<?php /**PATH C:\Users\Muhammad Kahfi\Downloads\Joki Doy\joyko\jokidoy\resources\views/layout/Admin.blade.php ENDPATH**/ ?>