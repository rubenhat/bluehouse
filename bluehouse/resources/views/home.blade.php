...
>
    ...
    <div class="relative z-10 max-w-3xl px-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            ...
            <a href="{{ route('cart.index') }}" class="bg-white text-blue-900 font-semibold py-3 px-8 rounded-xl shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 inline-block">
                Pesan Sekarang
            </a>
        </div>
    </div>
